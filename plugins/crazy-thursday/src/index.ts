...
export async function apply(ctx: Context, config: Config) {
  ...
  await ctx.nonebot.import(resolve(__dirname, '../nonebot_plugin_crazy_thursday/nonebot_plugin_crazy_thursday'), {
    crazy_path: Path('/pyodide/nonebot_plugin_crazy_thursday'),
  })
}
